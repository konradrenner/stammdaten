...
** Ubiquitous: appearing everywhere => users, architects, product owner, developer and code
...
* And then you could also do Software Design with the help of this tool (e.g. for designing Aggregates)
