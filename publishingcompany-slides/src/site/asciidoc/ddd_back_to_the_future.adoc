...
[NOTE.speaker]
--
* *First of all*: Because _"It’s developer’s (mis)understanding, not expert knowledge that gets released into production"_ - Alberto Brandolini
