...
These possiblity is offered by the "Building Block Views". The following table gives an overview of how the building block views, C4 Diagram and DDD are connectable.
