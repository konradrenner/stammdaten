...
If you are looking for a complete example of a fully filled arc42 template, you make have a look at the link:https://www.dokchess.de/[DokChess] example from the arc42 team.
