...
public class Fax extends TelefonAdresse {

    protected Fax() {
        super();
    }

    protected Fax(String adressid, String bezeichnung, short vorwahlLand, short vorwahl, short nummer, Short durchwahl) {
